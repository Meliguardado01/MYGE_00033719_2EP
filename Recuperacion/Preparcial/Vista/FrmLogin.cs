...
namespace Preparcial
{
    public partial class FrmLogin : Form
    {
        ...
        private void PoblarControlers()
        {
            ...
            //CORRECCION: Se cambio el nombre "Contrasenia" a "Contrasena", por eso no dejaba iniciar sesion.
        ...
        private void BttnUpdatePassword_Click(object sender, EventArgs e)
        {
            ...
            frmPassword.Show();
            //CORRECCION: Agregar lo de Poblar Controles para se actualice la contraseña.
            PoblarControlers();
